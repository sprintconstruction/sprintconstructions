...
(function() {
    ...
    function w(a, b, c) {
        ...
        (this._container = "string" === typeof this._containerId ? document.getElementById(this._containerId) : this._containerId) ? (this._container.innerHTML = "", b = a = 0, a = this._options.width ? this.width : 0 < this._container.clientWidth ? this._container.clientWidth : this.width, b = this._options.height ? this.height :
            ...
            d._updateSize() && d.render()
                ...
                "position: absolute; right: 1px; top: 1px;", this._canvasJSContainer.appendChild(this._toolBar), this.bounds = {x1: 0, y1: 0, x2: this.width, y2: this.height}, E(this.overlaidCanvas, "click", function(a) {
    ...
    function ia(a, b) {
        for (var c = [], d = 0; d < a.length; d++)
            if (0 == d)
                ...
                c[c.length] = {x: a[g].x + (a[f].x - a[e].x) / b / 3, y: a[g].y +
                            (a[f].y - a[e].y) / b / 3};
                g = d;
                e = 0 === g ? 0 : g - 1;
                f = g === a.length - 1 ? g : g + 1;
    ...
    var t = !!document.createElement("canvas").getContext, ma = {Chart: {width: 300, height: 400, zoomEnabled: !1, backgroundColor: "white", theme: "theme1", animationEnabled: !1, animationDuration: 1200, dataPointMaxWidth: null, colorSet: "colorSet1", culture: "en", creditText: "CanvasJS.com", interactivityEnabled: !0, exportEnabled: !1, exportFileName: "Chart"}, Title: {padding: 0,
        ...
        colorSet2: "#4F81BC #C0504E #9BBB58 #23BFAA #8064A1 #4AACC5 #F79647 #33558B".split(" "), colorSet3: "#8CA1BC #36845C #017E82 #8CB9D0 #708C98 #94838D #F08891 #0366A7 #008276 #EE7757 #E5BA3A #F2990B #03557B #782970".split(" ")}, Y = {theme1: {Chart: {colorSet: "colorSet1"}, Title: {fontFamily: t ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" : "calibri", fontSize: 33, fontColor: "#3A3A3A", fontWeight: "bold", verticalAlign: "top", margin: 5}, Subtitle: {fontFamily: t ? "Calibri, Optima, Candara, Verdana, Geneva, sans-serif" :
            ...
            null, sa = function() {
                ...
                return function(k, p, l) {
                    var h = l ? l.days : b, n = l ? l.months : d, m = l ? l.shortDays : c, q = l ? l.shortMonths : e;
                    l = "";
                    var r = !1;
                    ...
                    l = r ? "getUTC" : "get";
                    var s = k[l + "Date"](), t = k[l + "Day"](), u = k[l + "Month"](), v = k[l + "FullYear"](), C = k[l + "Hours"](), H = k[l + "Minutes"](), D = k[l + "Seconds"](), w = k[l + "Milliseconds"](), y = r ? 0 : k.getTimezoneOffset();
        ...
        b = String(b);
        var g = 1, k = c = "", p = -1, l = [], h = [], n = 0, m = 0, q = 0, r = !1, s = 0, k = b.match(/"[^"]*"|'[^']*'|[eE][+-]*[0]+|[,]+[.]|\u2030|./g);
        b = null;
        ...
        for (t = r = k = m = p = 0; 0 < l.length; )
            if (b = l.pop(), "#" === b || "0" === b)
                if (p++, p === n) {
                    ...
                    for (; 0 <
                            u.length; )
                        c = u.pop() + c, t++, 0 === t % r && (k === q && 0 < u.length) && (c = f + c);
                    d && (c = "-" + c)
                } else
                    0 < g.length ? (c = g.pop() + c, m++, t++) : "0" === b && (c = "0" + c, m++, t++), 0 === t % r && (k === q && 0 < g.length) && (c = f + c);
            else
        ...
        d = "";
        for (f = !1; 0 < h.length; )
            b = h.shift(), "#" === b || "0" === b ? 0 < a.length && 0 !== Number(a.join("")) ? (d += a.shift(), f = !0) : "0" === b && (d += "0", f = !0) : 1 < b.length && ('"' === b[0] && '"' === b[b.length - 1] || "'" === b[0] && "'" === b[b.length - 1]) ? d += b.slice(1, b.length - 1) : "E" !== b[0] && "e" !== b[0] || "0" !== b[b.length - 1] || !/[eE][+-]*[0]+/.test(b) ? d += b : (b = 0 > s ? b.replace("+", "").replace("-", "") : b.replace("-", ""), d += b.replace(/[0]+/, function(a) {
                return L(s, a.length)
            }));
        return c + ((f ? e : "") + d)
    }, na = function(a) {
    ...
    w.prototype._updateOptions = function() {
        ...
        if ("undefined" === typeof ma.Chart.creditHref)
            this.creditHref = "http://canvasjs.com/", this.creditText = "";
        else
    ...
    w.prototype.render = function(a) {
        ...
        0 < d.length ? (p.disableToolTip = !0, p._animator.animate(200, p.animationDuration, function(a) {
            ...
            for (var c = 0; c < d.length; c++)
                g = d[c], 1 > a && "undefined" !== typeof g.startTimePercent ? a >= g.startTimePercent && g.animationCallback(g.easingFunction(a -
    ...
    w.prototype.categoriseDataSeries = function() {
        for (var a =
            ...
            if (a = this.data[b], a.dataPoints && (0 !== a.dataPoints.length && a.visible) && 0 <= w._supportedChartTypes.indexOf(a.type)) {
                ...
                f || (e = {type: a.type,
                    previousDataSeriesCount: 0, index: c.plotUnits.length, plotType: c, axisYType: a.axisYType, axisY: "primary" === a.axisYType ? this.axisY : this.axisY2, axisX: this.axisX, dataSeriesIndexes: [], yTotals: []}, c.plotUnits.push(e));
                c.totalDataSeries++;
            ...
            function(a) {
                if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
                    for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = 0; g < a.dataSeriesIndexes.length; g++) {
                        var k = this.data[a.dataSeriesIndexes[g]], p = 0, l = !1, h = !1;
                        if ("normal" === k.axisPlacement || "xySwapped" === k.axisPlacement)
                            var n = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity, m = this.sessionVariables.axisX.internalMaximum ?
    ...
    w.prototype._processStackedPlotUnit = function(a) {
        if (a.dataSeriesIndexes &&
            ...
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = [], k = [], p = 0; p < a.dataSeriesIndexes.length; p++) {
                var l = this.data[a.dataSeriesIndexes[p]], h = 0, n = !1, m = !1;
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
                    var q = this.sessionVariables.axisX.internalMinimum ? this.sessionVariables.axisX.internalMinimum : this._options.axisX && this._options.axisX.minimum ? this._options.axisX.minimum : -Infinity, r = this.sessionVariables.axisX.internalMaximum ? this.sessionVariables.axisX.internalMaximum :
    ...
    w.prototype._processStacked100PlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length)) {
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f = !1, g = !1, k = !1, p = [], l = 0; l < a.dataSeriesIndexes.length; l++) {
                var h = this.data[a.dataSeriesIndexes[l]], n = 0, m = !1, q = !1;
    ...
    w.prototype._processMultiYPlotUnit = function(a) {
        if (a.dataSeriesIndexes && !(1 > a.dataSeriesIndexes.length))
            for (var b = a.axisY.dataInfo, c = a.axisX.dataInfo, d, e, f, g, k = !1, p = 0; p < a.dataSeriesIndexes.length; p++) {
                var l =
                        this.data[a.dataSeriesIndexes[p]], h = 0, n = !1, m = !1;
                if ("normal" === l.axisPlacement || "xySwapped" === l.axisPlacement)
            ...
            if (this._ignoreNextEvent)
                ...
                if (!e) {
                    if (w.capturedEventParam)
                        d = w.capturedEventParam, "mouseup" === c && (w.capturedEventParam = null, d.chart.overlaidCanvas.releaseCapture ? d.chart.overlaidCanvas.releaseCapture() : document.body.removeEventListener("mouseup", d.chart._mouseEventHandler, !1)), d.hasOwnProperty(c) &&
    ...
    w.prototype._plotAreaMouseDown = function(a, b) {
        this.isDrag = !0;
        this.dragStartPoint = "none" !== this.plotInfo.axisPlacement ? {x: a, y: b, xMinimum: this.axisX.minimum,
            xMaximum: this.axisX.maximum} : {x: a, y: b}
    };
    w.prototype._plotAreaMouseUp = function(a, b) {
        ...
        if (("normal" === this.plotInfo.axisPlacement || "xySwapped" === this.plotInfo.axisPlacement) && this.isDrag) {
            ...
            if (2 < Math.abs(e)) {
                if (this.panEnabled)
                    e = !1, d = 0, this.axisX.sessionVariables.internalMinimum < this.axisX._absoluteMinimum ? (d = this.axisX._absoluteMinimum -
    ...
    w.prototype.renderIndexLabels = function(a) {
        ...
        for (var b = this.plotArea, c = 0, d = 0, e = 0, f = 0, g = 0, k = d = g = e = 0, p = 0; p < this._indexLabels.length; p++) {
            var l =
                    this._indexLabels[p], f = l.chartType.toLowerCase(), h, n, m = N("indexLabelFontColor", l.dataPoint, l.dataSeries), k = N("indexLabelFontSize", l.dataPoint, l.dataSeries);
            h = N("indexLabelFontFamily", l.dataPoint, l.dataSeries);
            n = N("indexLabelFontStyle", l.dataPoint, l.dataSeries);
            var g = N("indexLabelFontWeight", l.dataPoint, l.dataSeries), d = N("indexLabelBackgroundColor", l.dataPoint, l.dataSeries), e = N("indexLabelMaxWidth", l.dataPoint, l.dataSeries), q = N("indexLabelWrap", l.dataPoint, l.dataSeries), r = {percent: null, total: null},
            s = null;
            ...
            if (l.dataSeries.indexLabelFormatter || l.dataPoint.indexLabelFormatter)
                s = {chart: this._options, dataSeries: l.dataSeries, dataPoint: l.dataPoint, index: l.indexKeyword, total: r.total, percent: r.percent};
            ...
            if (null !== t && "" !== t) {
                var c = N("indexLabelPlacement", l.dataPoint, l.dataSeries), r = N("indexLabelOrientation", l.dataPoint, l.dataSeries), s = l.direction, u = l.dataSeries.axisX, v = l.dataSeries.axisY, m = new G(a, {x: 0, y: 0, maxWidth: e ? e : 0.5 * this.width, maxHeight: q ? 5 * k : 1.5 * k, angle: "horizontal" ===
                ...
                if ("normal" === this.plotInfo.axisPlacement) {
                    ...
                    0 <= f.indexOf("line") || 0 <= f.indexOf("area") || 0 <= f.indexOf("scatter") ? (c = "auto", e = 4) : 0 <= f.indexOf("stacked") ? "auto" === c && (c = "inside") : "bubble" === f && (c = "inside"), n = l.point.y - k / 2, "inside" !==
        ...
        return{source: a, dest: this.plotArea.ctx,
                    ...
                    for (var q = !1, h = 0; h < k.length; h++)
                        if (n = k[h].getTime ? k[h].x.getTime() : k[h].x, !(n < a.axisX.dataInfo.viewPortMin || n > a.axisX.dataInfo.viewPortMax))
                            if ("number" !==
                                ...
                                (k[h].indexLabel || g.indexLabel || k[h].indexLabelFormatter || g.indexLabelFormatter) && this._indexLabels.push({chartType: "stepLine",
    ...
    w.prototype.renderSpline = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (var e = [], f = 0; f < a.dataSeriesIndexes.length; f++) {
                var g =
                        a.dataSeriesIndexes[f], k = this.data[g];
            ...
            c.beginPath();
            t && d.beginPath();
            return{source: c, dest: this.plotArea.ctx, animationCallback: y.xClipAnimation, easingFunction: y.easing.linear,
                animationBase: 0}
        }
    };
    ...
    w.prototype.renderColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var l = a.dataSeriesIndexes[d], n = this.data[l], m = n.dataPoints;
                if (0 < m.length)
                    for (var q = 5 < h && n.bevelEnabled ? !0 : !1, e = 0; e < m.length; e++)
                        if (m[e].getTime ? k = m[e].x.getTime() :
                            ...
                            (m[e].indexLabel || n.indexLabel || m[e].indexLabelFormatter || n.indexLabelFormatter) && this._indexLabels.push({chartType: "column", dataPoint: m[e], dataSeries: n, point: {x: f + (r - f) / 2, y: 0 <= m[e].y ?
                                            g : s}, direction: 0 <= m[e].y ? 1 : -1, bounds: {x1: f, y1: Math.min(g, s), x2: r, y2: Math.max(g, s)}, color: c})
                        }
            }
            b.restore();
    ...
    w.prototype.renderStackedColumn = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = [], f = [], g = 0, k, p = a.axisY.conversionParameters.reference +
                    a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, g = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, l = a.axisX.dataInfo.minDiff, h = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(l) / a.plotType.plotUnits.length) << 0;
            ...
            for (l = 0; l < a.dataSeriesIndexes.length; l++) {
                var n = a.dataSeriesIndexes[l], m = this.data[n], q = m.dataPoints;
                if (0 < q.length) {
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            var s = d - a.plotType.plotUnits.length * h / 2 + a.index * h << 0, z = s + h << 0, u;
                            if (0 <= q[g].y) {
                                var v = e[c] ? e[c] : 0;
                                k -= v;
                                u = p - v;
                                ...
                                v = f[c] ? f[c] : 0, u = k + v, k = p + v, f[c] = v + (u - k);
                            c = q[g].color ? q[g].color : m._colorSet[g % m._colorSet.length];
                            I(b, s, k, z, u, c, 0, null, r && 0 <= q[g].y, 0 > q[g].y && r, !1, !1, m.fillOpacity);
                            c = m.dataPointIds[g];
                            this._eventManager.objectMap[c] = {id: c, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: g, x1: s, y1: k,
                                x2: z, y2: u};
                            c = A(c);
            ...
            t && this._eventManager.ghostCtx.restore();
            a = Math.min(p, a.axisY.boundingRect.y2);
            return{source: b, dest: this.plotArea.ctx, animationCallback: y.yScaleAnimation,
                ...
                if (0 < q.length)
                    for (var r = 5 < h && m.bevelEnabled ? !0 : !1, g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c <
                            ...
                            c = A(c);
                            t && I(this._eventManager.ghostCtx, s, k, z, u, c, 0, null, !1, !1, !1, !1);
                            (q[g].indexLabel || m.indexLabel || q[g].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedColumn100",
                ...
                if (0 < m.length) {
                    ...
                    for (e = 0; e < m.length; e++)
                        if (m[e].getTime ? k = m[e].x.getTime() : k = m[e].x, !(k < a.axisX.dataInfo.viewPortMin || k > a.axisX.dataInfo.viewPortMax) && "number" === typeof m[e].y) {
                            ...
                            c = n.dataPointIds[e];
                            this._eventManager.objectMap[c] = {id: c, objectType: "dataPoint",
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            if (0 <=
                                ...
                                v = f[c] ? f[c] : 0, u = k - v, k = p - v, f[c] = v + (k - u);
                            c = q[g].color ? q[g].color : m._colorSet[g % m._colorSet.length];
                            ...
                            (q[g].indexLabel || m.indexLabel || q[g].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "stackedBar",
                    ...
                    for (g = 0; g < q.length; g++)
                        if (c = q[g].x.getTime ? q[g].x.getTime() : q[g].x, !(c < a.axisX.dataInfo.viewPortMin || c > a.axisX.dataInfo.viewPortMax) && "number" === typeof q[g].y) {
                            ...
                            this._eventManager.objectMap[c] =
                                    {id: c, objectType: "dataPoint", dataSeriesIndex: n, dataPointIndex: g, x1: u, y1: s, x2: k, y2: z};
                            c = A(c);
                            t && I(this._eventManager.ghostCtx, u, s, k, z, c, 0, null, !1, !1, !1, !1);
    ...
    w.prototype.renderArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                var p = a.dataSeriesIndexes[k], l = this.data[p], h = l.dataPoints, g = l.id;
                this._eventManager.objectMap[g] = {objectType: "dataSeries",
                    dataSeriesIndex: p};
                g = A(g);
                d.fillStyle = g;
                var g = [], n = !0, m = 0, q, r, s, z = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0, u, v = null;
                if (0 < h.length) {
                    ...
                    for (var H = !0; m < h.length; m++)
                        if (s = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if ("number" !==
                                ...
                                this._eventManager.objectMap[D] = {id: D, objectType: "dataPoint",
    ...
    w.prototype.renderSplineArea = function(a) {
        function b() {
            ...
            if (0 < b.length) {
                ...
                for (var g = 0; g < b.length - 3; g += 3)
                    c.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g + 2].y, b[g + 3].x, b[g + 3].y), t && d.bezierCurveTo(b[g + 1].x, b[g + 1].y, b[g + 2].x, b[g + 2].y, b[g + 3].x, b[g + 3].y);
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                g = A(g);
                d.fillStyle = g;
                var g = [], n = 0, m, q, r = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) +
                        0.5 << 0, s, z = null, u = [];
                if (0 < h.length) {
    ...
    w.prototype.renderStepArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (k = 0; k < a.dataSeriesIndexes.length; k++) {
                ...
                g = A(g);
                d.fillStyle = g;
                var g = [], n = !0, m = 0, q, r, s, z = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) + 0.5 << 0, u, v = null, C = !1;
                if (0 < h.length) {
                    var H =
                    ...
                    for (c.setLineDash && c.setLineDash(M(l.lineDashType, l.lineThickness)); m < h.length; m++)
                        if (s = h[m].x.getTime ? h[m].x.getTime() : h[m].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax)) {
                            ...
                            "number" !== typeof h[m].y ? (b(), C = !0) : (q = a.axisX.conversionParameters.reference + a.axisX.conversionParameters.pixelPerUnit * (s - a.axisX.conversionParameters.minimum) + 0.5 << 0, r = a.axisY.conversionParameters.reference +
                                ...
                                y: r, ctx: d, type: s.type, size: s.size, color: w, borderColor: w, borderThickness: s.borderThickness})), (h[m].indexLabel || l.indexLabel || h[m].indexLabelFormatter || l.indexLabelFormatter) && this._indexLabels.push({chartType: "stepArea", dataPoint: h[m], dataSeries: l, point: {x: q, y: r}, direction: 0 <= h[m].y ? 1 : -1, color: H}))
                        }
                    b();
                    K.drawMarkers(g)
                }
    ...
    w.prototype.renderStackedArea =
            function(a) {
                var b = a.targetCanvasCtx || this.plotArea.ctx;
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    var c = null, d = [], e = this.plotArea, f = [], g = [], k = 0, p, l, h, n = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (0 - a.axisY.conversionParameters.minimum) << 0, m = this._eventManager.ghostCtx;
                    t && m.beginPath();
                    b.save();
                    t && m.save();
                    b.beginPath();
                    ...
                    for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                        var q =
                                a.dataSeriesIndexes[e], r = this.data[q], s = r.dataPoints;
                        r.dataPointIndexes = [];
                    ...
                    for (e = 0; e < a.dataSeriesIndexes.length; e++) {
                        var q = a.dataSeriesIndexes[e], r = this.data[q], s = r.dataPoints, z = !0, u = [], k = r.id;
                        ...
                        if (0 < g.length) {
                            ...
                            for (k = 0; k < g.length; k++) {
                                h = g[k];
                                var v = null, v = 0 <= r.dataPointIndexes[h] ? s[r.dataPointIndexes[h]] : {x: h, y: 0};
                                if (!(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && "number" === typeof v.y) {
                                    ...
                                    f[h] = n - l;
                                    if (z)
                                        b.beginPath(), b.moveTo(p, l), t && (m.beginPath(), m.moveTo(p, l)), z = !1;
                            ...
                            for (0 < r.lineThickness && b.stroke(); 0 < u.length; )
                                H = u.pop(), b.lineTo(H.x, H.y), t && m.lineTo(H.x, H.y);
                            b.closePath();
                            b.globalAlpha = r.fillOpacity;
                            b.fill();
                            b.globalAlpha = 1;
                    ...
                    b.restore();
                    t && m.restore();
                    return{source: b, dest: this.plotArea.ctx, animationCallback: y.xClipAnimation,
    ...
    w.prototype.renderStackedArea100 = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            xValuePresent = [];
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var s = a.dataSeriesIndexes[d], z = this.data[s], u = z.dataPoints;
                z.dataPointIndexes = [];
                for (k = 0; k < u.length; k++)
                    s = u[k].x.getTime ? u[k].x.getTime() : u[k].x, z.dataPointIndexes[s] = k, xValuePresent[s] || (g.push(s), xValuePresent[s] = !0);
                g.sort(va)
            }
            for (d = 0; d < a.dataSeriesIndexes.length; d++) {
                var s =
                        a.dataSeriesIndexes[d], z = this.data[s], u = z.dataPoints, v = !0, c = z.id;
                ...
                if (0 < g.length) {
                    ...
                    for (k = 0; k < g.length; k++) {
                        h = g[k];
                        var w = null, w = 0 <= z.dataPointIndexes[h] ? u[z.dataPointIndexes[h]] : {x: h, y: 0};
                        if (!(h < a.axisX.dataInfo.viewPortMin ||
                            ...
                            f[h] = n - l;
                            if (v)
                                b.beginPath(), b.moveTo(p, l), t && (r.beginPath(), r.moveTo(p, l)), v = !1;
                            else if (b.lineTo(p,
                    ...
                    for (0 < z.lineThickness && b.stroke(); 0 <
                            C.length; )
                        U = C.pop(), b.lineTo(U.x, U.y), t && r.lineTo(U.x, U.y);
                    b.closePath();
                    b.globalAlpha = z.fillOpacity;
                    b.fill();
                    b.globalAlpha = 1;
    ...
    w.prototype.renderBubble = function(a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea, e = 0, f, g, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width << 0, e = a.axisX.dataInfo.minDiff, c = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(e) / c) << 0;
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
                ...
                if (n = a.dataSeriesIndexes[h], m = this.data[n], q = m.dataPoints, 1 == q.length && (c = k), 1 > c ? c = 1 : c > k && (c = k), 0 < q.length)
                    for (b.strokeStyle = "#4572A7 ", e = 0; e < q.length; e++)
                        if (f =
                            ...
                            var r = q[e].z, z = 2 * Math.max(Math.sqrt((p === l ? d / 2 : s + (d - s) / (p - l) * (r - l)) / Math.PI) << 0, 1), r = m.getMarkerProperties(e,
                                    b);
                            r.size = z;
                            ...
                            (q[e].indexLabel || m.indexLabel || q[e].indexLabelFormatter || m.indexLabelFormatter) && this._indexLabels.push({chartType: "bubble", dataPoint: q[e], dataSeries: m,
    ...
    w.prototype.renderScatter = function(a) {
        ...
        if (!(0 >= c)) {
            var d = this.plotArea, e = 0, f, g, k = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.15 * this.width <<
                    0, e = a.axisX.dataInfo.minDiff, c = 0.9 * (d.width / Math.abs(a.axisX.maximum - a.axisX.minimum) * Math.abs(e) / c) << 0;
            b.save();
            t && this._eventManager.ghostCtx.save();
            b.beginPath();
            b.rect(d.x1, d.y1, d.width, d.height);
            ...
            for (var p = 0; p < a.dataSeriesIndexes.length; p++) {
                var l = a.dataSeriesIndexes[p], h = this.data[l], n = h.dataPoints;
                1 == n.length && (c = k);
                1 > c ? c = 1 : c > k && (c = k);
                if (0 < n.length) {
                    b.strokeStyle = "#4572A7 ";
    ...
    w.prototype.renderCandlestick = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var d = null, d = this.plotArea, e = 0, f, g, k, p, l, h, e = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.015 * this.width;
                    ...
                    for (var z = 5 < n && r.bevelEnabled ? !0 : !1, e = 0; e < s.length; e++)
                        if (s[e].getTime ? h = s[e].x.getTime() : h = s[e].x, !(h < a.axisX.dataInfo.viewPortMin || h > a.axisX.dataInfo.viewPortMax) && null !== s[e].y && s[e].y.length && "number" === typeof s[e].y[0] && "number" === typeof s[e].y[1] && "number" === typeof s[e].y[2] && "number" === typeof s[e].y[3]) {
                            ...
                            l = a.axisY.conversionParameters.reference + a.axisY.conversionParameters.pixelPerUnit * (s[e].y[3] - a.axisY.conversionParameters.minimum) +
                                    0.5 << 0;
                            var u = f - n / 2 << 0, v = u + n << 0, d = s[e].color ? s[e].color : r._colorSet[0], C = Math.round(Math.max(1, 0.15 * n)), w = 0 === C % 2 ? 0 : 0.5, D = r.dataPointIds[e];
            ...
            b.restore();
            t && c.restore();
            return{source: b, dest: this.plotArea.ctx, animationCallback: y.fadeInAnimation, easingFunction: y.easing.easeInQuad,
                animationBase: 0}
        }
    };
    w.prototype.renderRangeColumn = function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = 0, f, g, e = this.dataPointMaxWidth ? this.dataPointMaxWidth : 0.03 * this.width;
            f = a.axisX.dataInfo.minDiff;
                ...
                if (0 < n.length)
                    for (var m = 5 < k && h.bevelEnabled ? !0 : !1, e = 0; e < n.length; e++)
                        if (n[e].getTime ? g = n[e].x.getTime() : g = n[e].x, !(g < a.axisX.dataInfo.viewPortMin || g > a.axisX.dataInfo.viewPortMax) && null !== n[e].y && n[e].y.length && "number" === typeof n[e].y[0] && "number" === typeof n[e].y[1]) {
                            ...
                            var q = c - a.plotType.totalDataSeries * k / 2 + (a.previousDataSeriesCount + p) * k << 0, r = q + k << 0, c = n[e].color ?
                            ...
                            if (n[e].indexLabel || h.indexLabel || n[e].indexLabelFormatter || h.indexLabelFormatter)
                                this._indexLabels.push({chartType: "rangeColumn", dataPoint: n[e], dataSeries: h, indexKeyword: 0, point: {x: q +
                                                (r - q) / 2, y: n[e].y[1] >= n[e].y[0] ? f : d}, direction: n[e].y[1] >= n[e].y[0] ? -1 : 1, bounds: {x1: q, y1: Math.min(d, f), x2: r, y2: Math.max(d, f)}, color: c}), this._indexLabels.push({chartType: "rangeColumn", dataPoint: n[e], dataSeries: h, indexKeyword: 1, point: {x: q + (r - q) / 2, y: n[e].y[1] >= n[e].y[0] ? d : f}, direction: n[e].y[1] >= n[e].y[0] ? 1 : -1, bounds: {x1: q, y1: Math.min(d, f), x2: r, y2: Math.max(d, f)}, color: c})
                        }
            }
            b.restore();
            t && this._eventManager.ghostCtx.restore();
            return{source: b, dest: this.plotArea.ctx, animationCallback: y.fadeInAnimation,
    ...
    w.prototype.renderRangeBar = function(a) {
        var b = a.targetCanvasCtx || this.plotArea.ctx;
        if (!(0 >= a.dataSeriesIndexes.length)) {
            var c = null, d = this.plotArea, e = 0, f, g, k, e = this.dataPointMaxWidth ? this.dataPointMaxWidth : Math.min(0.15 * this.height, 0.9 * (this.plotArea.height / a.plotType.totalDataSeries)) << 0;
            f = a.axisX.dataInfo.minDiff;
            ...
            for (var l = 0; l < a.dataSeriesIndexes.length; l++) {
                var h = a.dataSeriesIndexes[l], n = this.data[h], m = n.dataPoints;
                if (0 < m.length) {
    ...
    w.prototype.renderRangeArea = function(a) {
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                var g = [], k = a.dataSeriesIndexes[f], p = this.data[k], l = p.dataPoints, e = p.id;
                this._eventManager.objectMap[e] = {objectType: "dataSeries", dataSeriesIndex: k};
                e = A(e);
                d.fillStyle = e;
                var e = [], h = !0, n = 0, m, q, r, s, z = null;
                if (0 < l.length) {
                    ...
                    for (var v = !0; n < l.length; n++)
                        if (s = l[n].x.getTime ? l[n].x.getTime() : l[n].x, !(s < a.axisX.dataInfo.viewPortMin || s > a.axisX.dataInfo.viewPortMax))
                            if (null !== l[n].y && l[n].y.length && "number" === typeof l[n].y[0] && "number" === typeof l[n].y[1]) {
                                ...
                                h || v ? (c.beginPath(), c.moveTo(m, q), z = {x: m, y: q}, g = [], g.push({x: m, y: r}), t && (d.beginPath(), d.moveTo(m, q)), v = h = !1) : (c.lineTo(m, q), g.push({x: m,
                                    y: r}), t && d.lineTo(m, q), 0 == n % 250 && b());
                                s = p.dataPointIds[n];
                                ...
                                if (0 !== l[n].markerSize && (0 < l[n].markerSize || 0 < p.markerSize)) {
                                    ...
                                    e.push(C);
                                    w = A(s);
                                    t && e.push({x: m, y: q, ctx: d, type: C.type, size: C.size, color: w,
                                ...
                                if (l[n].indexLabel || p.indexLabel || l[n].indexLabelFormatter || p.indexLabelFormatter)
                                    this._indexLabels.push({chartType: "rangeArea", dataPoint: l[n], dataSeries: p, indexKeyword: 0, point: {x: m, y: q}, direction: l[n].y[0] <= l[n].y[1] ? -1 : 1, color: u}), this._indexLabels.push({chartType: "rangeArea", dataPoint: l[n], dataSeries: p, indexKeyword: 1, point: {x: m, y: r}, direction: l[n].y[0] <= l[n].y[1] ? 1 : -1, color: u})
                            } else
                                b(), v = !0;
                    b();
                    K.drawMarkers(e)
    ...
    w.prototype.renderRangeSplineArea = function(a) {
        function b() {
            ...
            if (0 < a.length) {
                ...
                if (0 < k.lineThickness) {
                    ...
                    for (b = a.length - 1; 2 < b; b -= 3)
                        c.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x, a[b - 2].y, a[b - 3].x, a[b - 3].y), t && d.bezierCurveTo(a[b - 1].x, a[b - 1].y, a[b - 2].x,
        ...
        if (!(0 >= a.dataSeriesIndexes.length)) {
            ...
            for (f = 0; f < a.dataSeriesIndexes.length; f++) {
                ...
                this._eventManager.objectMap[e] = {objectType: "dataSeries",
                    dataSeriesIndex: g};
                e = A(e);
                d.fillStyle = e;
                var e = [], l = 0, h, n, m, q = [], r = [];
                            ...
                            if (null !== p[l].y && p[l].y.length && "number" === typeof p[l].y[0] && "number" === typeof p[l].y[1]) {
                                ...
                                if (p[l].indexLabel || k.indexLabel || p[l].indexLabelFormatter || k.indexLabelFormatter)
                                    this._indexLabels.push({chartType: "splineArea",
                                        dataPoint: p[l], dataSeries: k, indexKeyword: 0, point: {x: h, y: n}, direction: p[l].y[0] <= p[l].y[1] ? -1 : 1, color: color}), this._indexLabels.push({chartType: "splineArea", dataPoint: p[l], dataSeries: k, indexKeyword: 1, point: {x: h, y: m}, direction: p[l].y[0] <= p[l].y[1] ? 1 : -1, color: color})
                            } else
                                0 < l && (b(), q = [], r = []);
                    b();
                    K.drawMarkers(e)
            ...
            function(a) {
                function b() {
                    if (h && n) {
                        ...
                        for (x = 0; x < n.length; x++) {
                            var e = n[x], f = h.dataPointIds[x], g = {id: f, objectType: "dataPoint", dataPointIndex: x, dataSeriesIndex: 0};
                            s.push(g);
                            var k = {percent: null, total: null}, m = null, k = l.getPercentAndTotal(h, e);
                            if (h.indexLabelFormatter || e.indexLabelFormatter)
                                m = {chart: l._options, dataSeries: h, dataPoint: e, total: k.total, percent: k.percent};
                            ...
                            g.indexLabelTextBlock = new G(l.plotArea.ctx, {fontSize: g.indexLabelFontSize, fontFamily: g.indexLabelFontFamily, fontColor: g.indexLabelFontColor,
                        ...
                        k = !1;
                        for (x = 0; x < n.length; x++)
                            g = s[(c + x) % n.length], 1 < a && (g.midAngle > Math.PI / 2 - v && g.midAngle < Math.PI / 2 + v) && (e <= a / 2 && !k ? (g.hemisphere = "right", e++) : (g.hemisphere = "left", k = !0));
                        k = !1;
                        for (x = 0; x < n.length; x++)
                ...
                function c(a) {
                    ...
                    for (b = 0; b < n.length; b++) {
                        var c = s[b].startAngle, d = s[b].endAngle;
                        if (d > c) {
                            var e = 0.07 * D * Math.cos(s[b].midAngle), f = 0.07 * D * Math.sin(s[b].midAngle), g = !1;
                            if (n[b].exploded) {
                                if (1E-9 < Math.abs(s[b].center.x -
                                        (y.x + e)) || 1E-9 < Math.abs(s[b].center.y - (y.y + f)))
                                    s[b].center.x = y.x + e * a, s[b].center.y = y.y + f * a, g = !0
                            } else if (0 < Math.abs(s[b].center.x - y.x) || 0 < Math.abs(s[b].center.y - y.y))
                                s[b].center.x = y.x + e * (1 - a), s[b].center.y = y.y + f * (1 - a), g = !0;
                ...
                function d(a, b) {
                    var c = a.indexLabelTextBlock.x, d = a.indexLabelTextBlock.y -
                            a.indexLabelTextBlock.height / 2, e = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height / 2, f = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2, g = b.indexLabelTextBlock.x + b.indexLabelTextBlock.width, h = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
                ...
                function e(a, b) {
                    var c = 0, c = a.indexLabelTextBlock.y - a.indexLabelTextBlock.height / 2, d = a.indexLabelTextBlock.y + a.indexLabelTextBlock.height /
                            2, e = b.indexLabelTextBlock.y - b.indexLabelTextBlock.height / 2, f = b.indexLabelTextBlock.y + b.indexLabelTextBlock.height / 2;
                ...
                function k() {
                    ...
                    for (var b = 0, c = a = 0, a = 0; 10 > a && (1 > a || 0 < c); a++) {
                        ...
                        for (b = 0; b < n.length; b++)
                            k = s[b], x = k.indexLabelTextBlock.measureText(), 0 !== x.height && 0 !== x.width && (x = x = 0, "right" === k.hemisphere ? (x = q.x2 - (k.indexLabelTextBlock.x + k.indexLabelTextBlock.width + m), x *= -1) : x = q.x1 - (k.indexLabelTextBlock.x - k.indexLabelTextBlock.width -
                ...
                if (!(0 >= a.dataSeriesIndexes.length)) {
                    for (var h =
                            this.data[a.dataSeriesIndexes[0]], n = h.dataPoints, m = 10, q = this.plotArea, r = 0, s = [], t = 2, u = 1.3, v = 20 / 180 * Math.PI, w = 6, y = {x: (q.x2 + q.x1) / 2, y: (q.y2 + q.y1) / 2}, D = "inside" === h.indexLabelPlacement ? 0.92 * Math.min(q.width, q.height) / 2 : 0.8 * Math.min(q.width, q.height) / 2, B = D * u, A = 0, x = 0; x < n.length; x++)
                        A += Math.abs(n[x].y);
                    0 !== A && (this.pieDoughnutClickHandler = function(a) {
                        l.isAnimating || (a = a.dataPoint, a.exploded = a.exploded ? !1 : !0, 1 < this.dataPoints.length && l._animator.animate(0, 500, function(a) {
                            ...
                            !0, this._animator.animate(0, this.animatedRender ? this.animationDuration : 0, function(a) {
                                ...
                                for (b = 0; b < n.length; b++) {
                                    var c = 0 === b ? s[b].startAngle : d, d = c + (s[b].endAngle - s[b].startAngle), e = !1;
                                    d > a && (d = a, e = !0);
    ...
    G.prototype._wrapText = function() {
        var a = new String(aa(String(this.text))), b = [], c = this.ctx.font, d = 0, e = 0;
    ...
    ca.prototype.render = function() {
        if (this.text) {
            var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart,
                    b = a.layoutManager.getFreeSpace(), c = b.x1, d = b.y1, e = 0, f = 0, g = this.chart._menuButton && this.chart.exportEnabled && "top" === this.verticalAlign ? 22 : 0, k, p;
            ...
            var f = new G(this.ctx, {fontSize: this.fontSize, fontFamily: this.fontFamily, fontColor: this.fontColor, fontStyle: this.fontStyle, fontWeight: this.fontWeight, horizontalAlign: this.horizontalAlign, verticalAlign: this.verticalAlign, borderColor: this.borderColor, borderThickness: this.borderThickness, backgroundColor: this.backgroundColor, maxWidth: this.maxWidth,
                maxHeight: f, cornerRadius: this.cornerRadius, text: this.text, padding: this.padding, textBaseline: "top"}), l = f.measureText();
    ...
    ka.prototype.render = function() {
        var a = this.dockInsidePlotArea ? this.chart.plotArea : this.chart, b = a.layoutManager.getFreeSpace(), c = null, d = 0, e = 0, f = 0, g = 0, k = [], p = [];
            ...
            for (l = 0; l < k.length; l++) {
                ...
                if (!(0 >=
                    ...
                    if ("horizontal" === this.orientation) {
                        ...
                        n.textBlock = new G(this.ctx, {x: 0, y: 0, maxWidth: m, maxHeight: !0 === this.itemWrap ? g : 1.5 * this.fontSize, angle: 0, text: n.text, horizontalAlign: "left",
        ...
        for (l = 0; l < this.items.length; l++)
            n = k[l], n.id = ++this.chart._eventManager.lastObjectId, this.chart._eventManager.objectMap[n.id] =
                    {id: n.id, objectType: "legendItem", legendItemIndex: l, dataSeriesIndex: n.dataSeriesIndex, dataPointIndex: n.dataPointIndex};
        for (l = b = 0; l < p.length; l++) {
            ...
            for (k = u = 0; k < h.items.length; k++) {
                ...
                if ("line" === n.chartType || "stepLine" === n.chartType || "spline" === n.chartType)
                    this.ctx.strokeStyle = n.lineColor, this.ctx.lineWidth =
    ...
    R.prototype.getDataPointAtX = function(a, b) {
        if (!this.dataPoints || 0 === this.dataPoints.length)
            return null;
        var c = {dataPoint: null, distance: Infinity, index: NaN}, d = null, e = 0, f = 0, g = 1, k = Infinity, p = 0, l = 0, h = 0;
    ...
    R.prototype.getDataPointAtXY = function(a, b, c) {
        ...
        c = c || !1;
        var d = [], e =
                0, f = 0, g = 1, k = !1, p = Infinity, l = 0, h = 0, n = 0;
        ...
        for (; ; ) {
            f = 0 < g ? n + e : n - e;
            if (0 <= f && f < this.dataPoints.length) {
                var m = this.chart._eventManager.objectMap[this.dataPointIds[f]], q = this.dataPoints[f], r = null;
                if (m) {
                    switch (this.type) {
                        case "column":
                        case "stackedColumn":
                        ...
                        case "splineArea":
                        case "scatter":
                            var s = N("markerSize", q, this) || 4, t = c ? 20 : s, r = Math.sqrt(Math.pow(m.x1 - a, 2) + Math.pow(m.y1 - b, 2));
                        ...
                        case "bubble":
                            ...
                            r <= s / 2 && (d.push({dataPoint: q, dataPointIndex: f, dataSeries: this,
                                distance: r}), k = !0);
                            break;
                        case "pie":
                        case "doughnut":
                            ...
                            r < m.radius && r > t && (r = Math.atan2(b - s.y, a - s.x), 0 > r && (r += 2 * Math.PI), r = Number(((180 * (r / Math.PI) % 360 + 360) % 360).toFixed(12)), s = Number(((180 * (m.startAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), t = Number(((180 * (m.endAngle / Math.PI) % 360 + 360) % 360).toFixed(12)), 0 === t && 1 < m.endAngle && (t = 360), s >= t && 0 !== q.y && (t += 360, r < s && (r += 360)), r > s && r < t && (d.push({dataPoint: q, dataPointIndex: f,
                                dataSeries: this, distance: 0}), k = !0));
                            break;
                        case "candlestick":
    ...
    x.prototype.createLabels = function() {
        ...
        if ("axisX" === this.type && "dateTime" === this.chart.plotInfo.axisXValueType)
            for (c =
                ...
                a = b.getTime(), a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this._options, value: b, label: this.labels[b] ? this.labels[b] : null}) : "axisX" === this.type && this.labels[a] ? this.labels[a] : sa(b, this.valueFormatString, this.chart._cultureInfo), a = new G(this.ctx, {x: 0, y: 0, maxWidth: d, maxHeight: e, angle: this.labelAngle, text: this.prefix + a + this.suffix, horizontalAlign: "left",
                    fontSize: this.labelFontSize, fontFamily: this.labelFontFamily, fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle"}), this._labels.push({position: b.getTime(), textBlock: a, effectiveHeight: null});
        else {
            c = this.maximum;
            ...
            for (b = this.intervalstartTimePercent; b <= c; b = parseFloat((b + this.interval).toFixed(14)))
                a = this.labelFormatter ? this.labelFormatter({chart: this.chart, axis: this._options, value: b, label: this.labels[b] ? this.labels[b] : null}) : "axisX" === this.type && this.labels[b] ? this.labels[b] : X(b, this.valueFormatString, this.chart._cultureInfo), a = new G(this.ctx, {x: 0, y: 0, maxWidth: d, maxHeight: e, angle: this.labelAngle, text: this.prefix + a + this.suffix, horizontalAlign: "left", fontSize: this.labelFontSize, fontFamily: this.labelFontFamily,
                    fontWeight: this.labelFontWeight, fontColor: this.labelFontColor, fontStyle: this.labelFontStyle, textBaseline: "middle", borderThickness: 0}), this._labels.push({position: b, textBlock: a, effectiveHeight: null})
        }
        for (b = 0; b < this.stripLines.length; b++)
            c = this.stripLines[b], a = new G(this.ctx, {x: 0, y: 0, backgroundColor: c.labelBackgroundColor, maxWidth: d, maxHeight: e, angle: this.labelAngle, text: c.labelFormatter ? c.labelFormatter({chart: this.chart, axis: this, stripLine: c}) : c.label, horizontalAlign: "left", fontSize: c.labelFontSize,
                fontFamily: c.labelFontFamily, fontWeight: c.labelFontWeight, fontColor: c._options.labelFontColor || c.color, fontStyle: c.labelFontStyle, textBaseline: "middle", borderThickness: 0}), this._labels.push({position: c.value, textBlock: a, effectiveHeight: null, stripLine: c})
    };
    ...
    x.prototype.renderLabelsTicksAndTitle = function() {
        ...
        if ("bottom" === this._position) {
            ...
            this.title && (this._titleTextBlock = new G(this.ctx, {x: this.lineCoordinates.x1, y: this.boundingRect.y1 + 1, maxWidth: this.lineCoordinates.width, maxHeight: 1.5 * this.titleFontSize, angle: 0, text: this.title, horizontalAlign: "center", fontSize: this.titleFontSize, fontFamily: this.titleFontFamily, fontWeight: this.titleFontWeight, fontColor: this.titleFontColor, fontStyle: this.titleFontStyle,
                textBaseline: "top"}), this._titleTextBlock.measureText(), this._titleTextBlock.x = this.lineCoordinates.x1 + this.lineCoordinates.width / 2 - this._titleTextBlock.width / 2, this._titleTextBlock.render(!0))
            ...
            for (e = 0; e < this._labels.length; e++)
                if (f = this._labels[e], !(f.position < this.minimum || f.position > this.maximum)) {
                    ...
                    if (!a || 0 === d++ % 2 || this._labels[e].stripLine)
                        f.textBlock.x = b.x - f.textBlock.width * Math.cos(Math.PI / 180 * this.labelAngle) - this.tickLength - 5, f.textBlock.y = 0 === this.labelAngle ? b.y : b.y - f.textBlock.width *
            ...
            this.title && (this._titleTextBlock = new G(this.ctx, {x: this.boundingRect.x2 - 1, y: this.lineCoordinates.y2, maxWidth: this.lineCoordinates.height,
                maxHeight: 1.5 * this.titleFontSize, angle: 90, text: this.title, horizontalAlign: "center", fontSize: this.titleFontSize, fontFamily: this.titleFontFamily, fontWeight: this.titleFontWeight, fontColor: this.titleFontColor, fontStyle: this.titleFontStyle, textBaseline: "top"}), this._titleTextBlock.measureText(), this._titleTextBlock.y = this.lineCoordinates.height / 2 - this._titleTextBlock.width / 2 + this.lineCoordinates.y1, this._titleTextBlock.render(!0))
        }
    };
    x.prototype.renderInterlacedColors = function() {
        var a = this.chart.plotArea.ctx,
                b, c, d = this.chart.plotArea, e = 0;
        b = !0;
    ...
    x.getNiceNumber = function(a, b) {
        var c =
                Math.floor(Math.log(a) / Math.LN10), d = a / Math.pow(10, c);
    ...
    x.prototype.getLabelStartPoint = function() {
        var a = $(this.interval, this.intervalType), a = new Date(Math.floor(this.minimum / a) * a);
        ...
        for (var c = 0, d = 0; d < a.length; d++) {
            ...
            if ((e = this.chart._eventManager.objectMap[e.dataSeries.dataPointIds[e.index]]) && e.objectType && "dataPoint" === e.objectType) {
                var c = this.chart.data[e.dataSeriesIndex],
                        f = c.dataPoints[e.dataPointIndex], g = e.dataPointIndex;
    ...
    Q.prototype.getToolTipInnerHTML = function(a) {
        ...
        if (g && (this.content && "function" === typeof this.content || this.contentFormatter))
            a = {chart: this.chart, toolTip: this._options, entries: a}, b = this.contentFormatter ? this.contentFormatter(a) : this.content(a);
    ...
    w.prototype.getPercentAndTotal = function(a, b) {
        ...
        if (0 <= a.type.indexOf("stacked"))
            d = 0, c = b.x.getTime ? b.x.getTime() : b.x, c in a.plotUnit.yTotals && (d = a.plotUnit.yTotals[c], e = isNaN(b.y) ? 0 : 0 === d ? 0 : 100 * (b.y / d));
    ...
    w.prototype.replaceKeywordsWithValue = function(a, b, c, d, e) {
        ...
        if ((0 <= c.type.indexOf("stacked") || "pie" === c.type || "doughnut" === c.type) && (0 <= a.indexOf("#percent") || 0 <= a.indexOf("#total"))) {
            var g = "#percent", k = "#total", p = this.getPercentAndTotal(c, b), k = p.total ? p.total : k, g = isNaN(p.percent) ? g : p.percent;
            do {
                p = "";
                if (c.percentFormatString)
                    p = c.percentFormatString;
                else {
                    var p = "#,##0.", l = Math.max(Math.ceil(Math.log(1 / Math.abs(g)) / Math.LN10), 2);
    ...
    var y = {yScaleAnimation: function(a, b) {
            ...
            }}}, K = {drawMarker: function(a, b, c, d, e, f, g, k) {
            if (c) {
                var p = 1;
